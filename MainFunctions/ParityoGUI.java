...
/**
 * 
 *<h1>L‰‰kiksen ilmoittautumisohjelma proto</h1>
 * 
 *Main(P‰‰ohjelma ja GUI)
 * 
 *K‰ynnist‰‰ olut-reseptikirjasto ohjelman graafisen k‰yttˆliittym‰n
 * 
 *<p>
 *
 *@author Juusoha
...
public class ParityoGUI extends Application{
	...
	public void start(Stage AloitusIkkuna){
		//Luodaan paneeli p‰‰valikkoa varten
		...
		kayttajatunnus.setPromptText("K‰ytt‰j‰tunnus:");
		...
		//Luodaan olio ParityoTestilomake luokasta
		ParityoTestilomake lomake = new ParityoTestilomake();
		
		//K‰ynnistet‰‰n sis‰‰nkirjautuminen, metodissa tietojen syˆttˆ
		log_in.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent e) {
				...
				tietojenkysely.setTitle("Tietotojen t‰yttˆ");
